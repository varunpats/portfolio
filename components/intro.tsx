...
import img from '../public/Varun.jpg';
...
export default function Intro() {
    ...
    return (
        <motion.section ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
            ...
            >
                <span className="font-bold">Hello, I'm Varun.</span> A{" "}
            ...
            >
                ...
                <a className='group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10' href='/CV.pdf' download>Download CV<LiaDownloadSolid className='opacity-60 group-hover:translate-y-1 transition' /></a>
